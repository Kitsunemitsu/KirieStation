...
/obj/machinery/clonepod
	...
	density = TRUE
	icon = 'ModularBungalow/zbungalowicons/cloning/cloning_pod.dmi'
	icon_state = "pod_0"
	req_access = list(ACCESS_CMO) //FOR PREMATURE UNLOCKING.
	verb_say = "states"
...
/obj/machinery/clonepod/update_overlays()
	. = ..()
	if(mess)
		var/mutable_appearance/gib1 = mutable_appearance('ModularBungalow/zbungalowicons/cloning/cryo_mobs.dmi', "gibup")
		var/mutable_appearance/gib2 = mutable_appearance('ModularBungalow/zbungalowicons/cloning/cryo_mobs.dmi', "gibdown")
		...
		if(completion > 0.7)
			...
			occupant_overlay = mutable_appearance('ModularBungalow/zbungalowicons/cloning/cryo_mobs.dmi', "clone_meat")
