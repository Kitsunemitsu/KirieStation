...
/obj/effect/collapse/proc/collapse()
	...
	visible_message("<span class='boldannounce'>The tendril falls inward, the ground around it erupting into bubbling lava!</span>") //kirie edit, fuck chasms
	for(var/turf/T in range(2,src))
		if(!T.density)
			T.TerraformTurf(/turf/open/lava/smooth/lava_land_surface, /turf/open/lava/smooth/lava_land_surface, flags = CHANGETURF_INHERIT_AIR) //kirie edit, fuck chasms part 2
	qdel(src)
